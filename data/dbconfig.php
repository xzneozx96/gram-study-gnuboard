...
define('G5_MYSQL_USER', 'ross_admin');
define('G5_MYSQL_PASSWORD', 'tuan1809');
define('G5_MYSQL_DB', 'gram_study');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'BRI_');

define('G5_TOKEN_ENCRYPTION_KEY', 'e050568e0a4d289db6e4ab7785991fdf'); // 토큰 암호화에 사용할 키
...
define('G5_SHOP_TABLE_PREFIX', 'BRI_shop_');
