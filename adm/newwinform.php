...
// 팝업레이어 테이블에 쇼핑몰, Xin chào 인지 구분하는 여부 필드 추가
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <?php echo help("Xin chào에 표시될 것인지 쇼핑몰에 표시될 것인지를 설정합니다."); ?>
                        <select name="nw_division" id="nw_division">
                            <option value="comm" <?php echo get_selected($nw['nw_division'], 'comm'); ?>>Xin chào</option>
                            <?php if (defined('G5_USE_SHOP') && G5_USE_SHOP) { ?>
                                <option value="both" <?php echo get_selected($nw['nw_division'], 'both', true); ?>>Xin chào와 쇼핑몰</option>
