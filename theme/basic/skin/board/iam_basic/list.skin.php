             ...
             <div class="bo_sch_wrap">
                <fieldset id="bo_sch">
                        ...
                        <select name="sfl" id="sfl">
                        	<option value="wr_subject||wr_subject"<?php echo get_selected($sfl, 'wr_subject||wr_content'); ?>>전체</option>
                        ...
                        <button type="submit" value="검색" class="sch_btn"><span>검색</span><i class="xi-search"></i></button>
                        </form>
                </fieldset>
            </div>
            <!-- } 게시판 검색 끝 -->  
				...
				<div class="bo_list_head">
                        ...
                        <span class="s-day"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>작성일 <i class="fa fa-sort" aria-hidden="true"></i></a></span>
				...
				<div class="bo_list">
						...
						<li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>"">
								...
								if ($list[$i]['is_notice']) // 공지사항
										echo '<strong class="mobile_none" style="display:inline-block; border:1px solid #53566a; border-radius:10px; height:27px; line-height:27px; padding:0 7px;" >공지</strong>';
								...
								<span class="s-name" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px" onclick="location.href='<?php echo $list[$i]['href'] ?>'">
										...
										<?php } ?>
												...
												<a href="<?php echo $list[$i]['href'] ?>">
														...
														<?php echo conv_subject($list[$i]['wr_subject'], 30, "..."); ?>
								...
								<span class="s-view mb_none"><nobr class="pc_none"></nobr> <?php echo $list[$i]['wr_hit'] ?></span>
