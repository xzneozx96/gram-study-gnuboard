		...
		<section id="bo_w">
                ...
                <div class="wr_top">
                    ...
                    <div class="option-box">
                            <div class="tlt">옵션</div>
                            <div class="cts"><?php echo $option ?></div>
                    </div>
                    <?php } ?>
    
                    <div class="bo_w_tit write_div subject_cts">
                            <!-- <label for="wr_subject" class="sound_only">제목<strong>필수</strong></label> -->
                            
                            <div id="autosave_wrapper write_div">
                                <div class="tlt">제목</div>
                                <div class="cts"><input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="">
