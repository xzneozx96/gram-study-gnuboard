	...
	<div class="r-sub-con">
		...
		<article id="bo_v" style="width:<?php echo $width; ?>">
				...
				<div id="bo_v_top">
                        ...
                        <ul class="bo_v_nb">
                            <?php if ($prev_href) { ?><a href="<?php echo $prev_href ?>"><li class="btn_prv"><span class="nb_tit"><i class="xi-caret-up-min" aria-hidden="true"></i> 이전글</span> <span class="mb_none"><?php echo $prev_wr_subject;?></span></a> <!--<span class="nb_date"><?//php echo str_replace('-', '.', substr($prev_wr_date, '2', '8')); ?></span>--></li><?php } ?>
                            <?php if ($next_href) { ?><li class="btn_next"><a href="<?php echo $next_href ?>"><span class="mb_none"><?php echo $next_wr_subject;?></span> <span class="nb_tit"> 다음글 <i class="xi-caret-down-min" aria-hidden="true"></i></span></a>  <!--<span class="nb_date"><?//php echo str_replace('-', '.', substr($next_wr_date, '2', '8')); ?></span>--></li><?php } ?>
                        </ul>
                        <?php } ?>
						...
						<ul class="bo_v_com">
							 <li><a href="<?php echo $list_href ?>" class="list_view">List<i class="xi-apps"></i></a></li>
