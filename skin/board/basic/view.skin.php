...
<div class="blog_hero sub_page_banner">
    <div class="container">
        ...
        <h2 id="bo_v_title">
            ...
            <!-- <span> -->
            <?php
            echo cut_str(get_text($view['wr_subject']), 150); // 글제목 출력
            ?>
            <!-- </span> -->
        </h2>
        </div>
...
<article class="container" id="bo_v" style="width:<?php echo $width; ?>; padding: 80px 0">
