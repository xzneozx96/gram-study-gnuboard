						...
						if($v_img_count) {
								...
								for ($i=0; $i<=count($view['file']); $i++) {
										if ($view['file'][$i]['view']) {
												...
												echo "<li style='float:left;margin-right:5px;'>".get_view_thumbnail($view['file'][$i]['view'],350)."</li>";
										}
								}
...
<div style='clear:both;'></div>
		...
		<div id='bo_list' class="tbl_head01" style='margin-top:20px;'>
				<table>
				<tbody>
					<tr>
						<th width='150'>지역</th>
						<td><?php echo get_text($view['wr_1']);?> <?php echo get_text($view['wr_2']);?></td>
					</tr>
					<tr>
						<th>매장명</th>
						<td><?php echo get_text($view['wr_subject']);?></td>
					</tr>
					<tr>
						<th>주소</th>
						<td><?php echo get_text($view['wr_content']);?></td>
					</tr>
					<tr>
						<th>전화번호</th>
